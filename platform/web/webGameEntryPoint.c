...
void victoriaWebHandleGamePointer(Unsigned32 action, Integer32 x, Integer32 y);
...
Unsigned32 victoriaWebInitialize(Unsigned32 widthInPixels, Unsigned32 heightInPixels,
                                 Unsigned32 graphicsMemoryLimitBytes)
{
    return (Unsigned32)engineInitializeGame(NULL_POINTER, widthInPixels, heightInPixels,
...
Unsigned32 victoriaWebOpenDisc(double sizeInBytes)
{
    ...
    engineBeginGameLoad(&discFileSystem);
    return 1U;
}
...
Unsigned32 victoriaWebStepDiscLoad(void)
{
    return (Unsigned32)engineStepGameLoad();
}
...
WEB_EXPORT("victoriaWebHandleGamePointer")
void victoriaWebHandleGamePointer(Unsigned32 action, Integer32 x, Integer32 y)
{
    (void)engineHandleGamePointer((EnginePointerAction)action, x, y);
}
